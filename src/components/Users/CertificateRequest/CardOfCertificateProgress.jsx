...
import aprrovedstatus from "../../../assets/images/approvestatus.svg";
import pendingstatus from "../../../assets/images/pendingstatus.svg";
import rejectedstatus from "../../../assets/images/rejectedstatus.svg";
import verifiedstatus from "../../../assets/images/verifiedstatus.svg";

export default function CardOfCertificateProgress() {
  const date = new Date();
  ...
  var data = [
    ...
    },
    {
      ...
      created: formattedDate,
      image: aprrovedstatus,
      status: "approved"
    },
    {
      Name: "Bacll Certificate",
      created: formattedDate,
      image: verifiedstatus,
      status: "verified"
    },
    {
      Name: "Diploma Certificate",
      created: formattedDate,
      image: rejectedstatus,
      status: "rejected"
    },
    {
      Name: "Bacll Certificate",
