...
const TotalUsers = () => {
  return (
    <div className="bg-gradient-to-r from-lightprimary from-3.39% to-primary to-99.87%  w-[270px] p-[16px] rounded-[12px]  ">
      <div className="bg-black p-[12px] rounded-[48px] w-[48px] h-[48px] ">
      ...
      <div className=" flex flex-col ">
        ...
        <div className="bg-white p-[4px] rounded-[6px] w-fit ">
