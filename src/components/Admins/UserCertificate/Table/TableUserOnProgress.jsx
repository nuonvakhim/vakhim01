      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg mt-[33px] mb-[22px]">
        <table className="w-full text-sm text-left table-auto ">
          ...
          {data === null || data === undefined || data?.length === 0 ? (
            ...
            <tbody>
              {data?.map((item, key) => (
                <tr className={key % 2 == 0 ? "bg-white" : " bg-[#e4f8fa]} "}>
                  <th
                    scope="row"
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={
                        item?.status === "pending"
                          ? " w-28 text-[14px] leading-[22px] outline outline-[#D36500] rounded-[35px] flex px-[11px] justify-center items-center text-[#D36500]  capitalize bg-[#FFF2E5]"
                          : " w-28 text-[14px] leading-[22px] outline outline-[#0e8954] rounded-[35px] flex px-[11px] justify-center items-center text-[#0e8954]  capitalize bg-[#F0FFF9]"
                      }
                    >
                      {item?.status}
                    </span>
...
export default TableUserOnProgress;