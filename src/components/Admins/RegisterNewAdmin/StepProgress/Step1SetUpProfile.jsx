...
const Step1SetUpProfile = () => {
  ...
  return (
    <div className="inline-flex flex-col items-start gap-[10px]">
      ...
      <div className=" bg-[#FAFAFA] rounded-[6px] w-full border border-[#DCDCE4] pl-[230px] pr-[231px] pt-[10px] pb-[10px] justify-center items-center flex ">
        <div className="flex flex-col items-center gap-[5px]">
          ...
          <div className="text-primary text-center text-[14.4px] font-normal -tracking-[0.288px] ">
            Enter the login information for new account. <br /> You will be able
            to create additional user after registering{" "}
          </div>
        </div>
      </div>
      {/* Form Input */}
        ...
        <div className="flex w-[325px] flex-col items-start gap-[5px] flex-shrink-0">
          <div className="flex w-full flex-col gap-[8px] items-start ">
            ...
            <Input
              ...
              className="flex py-[8px] pl-[17px] pr-[10px] items-center gap-[10px] rounded-[6px] border border-[#DCDCE4] bg-white focus:ring-primary focus:outline-primary"
              prefix={
                <svg
          ...
          <div className="flex w-full flex-col gap-[8px] items-start ">
            ...
            <Input
              ...
              className="flex py-[8px] pl-[17px] pr-[10px] items-center gap-[10px] rounded-[6px] border border-[#DCDCE4] bg-white"
              prefix={
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="17"
        ...
        <div className="flex w-[325px] flex-col items-start gap-[5px] flex-shrink-0">
          ...
          <div className="flex w-full flex-col gap-[8px] items-start ">
            ...
            <DatePicker
              ...
              className="flex w-full py-[8px] pl-[17px] pr-[10px] items-center gap-[10px] rounded-[6px] border border-[#DCDCE4] bg-white"
            />
          </div>
        </div>
      </div>
      ...
      <div className="flex w-full flex-col gap-[8px] items-start ">
        ...
        <TextArea
          ...
          className="flex w-[836px] h-[106px] py-[8px] pl-[17px] pr-[10px] items-center gap-[10px] rounded-[8.078px] border border-[#DCDCE4] bg-white"
        />
      </div>
    </div>
  );
...
export default Step1SetUpProfile;
